...
node {
        ...
        */
        ...
        def testApp = openshift.newApp("s2i-ruby:${tag}~https://github.com/ausnimbus/ruby-ex", "-l app=ruby-ex");
        ...
        openshift.tag("ausnimbus-ci/s2i-ruby:${tag}", "ausnimbus-staging/s2i-ruby:${tag}")
}
